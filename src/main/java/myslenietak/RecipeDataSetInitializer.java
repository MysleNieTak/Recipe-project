...
public class RecipeDataSetInitializer {
    ...
    void init(){
        ...
        recipeRepository.saveAll(Arrays.asList(new Recipe("Łosoś pieczony 1", "Pieczony łosoś w sosie koperkowym 1", 120, 2, "Łosoś, śmietanka, koperek, masło, cytryna, sól, pieprz, ziemniaki, brokuł", Complexity.EASY)));
        ...
        recipeRepository.saveAll(Arrays.asList(new Recipe("Łosoś pieczony 2", "Pieczony łosoś w sosie koperkowym 2", 120, 2, "Łosoś, śmietanka, koperek, masło, cytryna, sól, pieprz, ziemniaki, brokuł", Complexity.EASY)));
